...
This is the foundation release. It establishes and verifies the connection to Whisparr and captures
the settings later phases build on:
...
Library reconciliation and acquisition auto-import (acting on the webhook) arrive in later phases.
