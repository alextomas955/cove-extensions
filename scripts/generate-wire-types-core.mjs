...
//
// This is the core; scripts/generate-wire-types.mjs is the command-line entry point and its whole body
// is the call. Split for the reason assemble-package-core.mjs states: a condition in an entry point can
// be wrong in the one way that leaves no trace.
