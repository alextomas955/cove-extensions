...
// gets the imported type silently degraded to `any` rather than an error — every prop on every call
// site then type-checks against nothing. Re-declare the shape you need instead.
...
// find module) — the error names the real problem.
//
