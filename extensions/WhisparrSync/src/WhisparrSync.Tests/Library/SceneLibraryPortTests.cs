...
/// <c>StreamAllVideosAsync</c> maps them (same endpoint filter, same shape), and an absent id returns null.
/// </summary>
[Trait("Tier", "L1")]
public sealed class SceneLibraryPortTests
{
    ...
    public async Task LoadVideoById_ReturnsMappedScene_WithStashDbEndpointIds()
    {
        ...
        try
        {
            ...
            // Same StashDB-endpoint filter as StreamAllVideosAsync: the ThePornDB id is excluded.
