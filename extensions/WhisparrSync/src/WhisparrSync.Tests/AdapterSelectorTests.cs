...
/// <summary>
/// The version-gate proof (VER-03/VER-04): the major is parsed from the dotted version string, a v3
...
/// rather than a silent wrong-adapter call (VER-04 fail-closed preserved for major != 2, 3).
/// </summary>
public sealed class AdapterSelectorTests
{
    ...
    {
        // VER-04 fail-closed: only major 2 and 3 are supported — everything else (garbage OR a
