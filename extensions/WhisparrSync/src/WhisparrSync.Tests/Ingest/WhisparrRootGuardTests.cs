...
public sealed class WhisparrRootGuardTests
{
    ...
    public void CaseVariantOfRoot_IsNotWithin_CaseSensitive()
        // Containment is case-SENSITIVE. On the Linux/Docker target /data/Media is a different directory
    ...
    {
        // A symlink INSIDE a root pointing OUT of it (e.g. /root/link -> /outside) must not let a path
