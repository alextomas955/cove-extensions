...
public sealed class OptionsRedactionTests
{
    ...
    public void OptionsView_OmitsApiKey_ExposesHasApiKey()
    {
        ...
        // The serialized view exposes the hasApiKey boolean and never the key value. Serialized through the
        // real Cove-facing wire serializer (camelCase Web convention), so hasApiKey is the emitted name.
        var json = JsonSerializer.Serialize(withKey, WireSerializers.WebResponseJsonOptions);
    ...
    public void WithSubmitted_EmptyKey_PreservesStoredKey()
    {
        ...
        var updated = stored.WithSubmitted(
            baseUrl: "http://new", apiKey: "", selectedVersion: "v3");
    ...
    public void WithSubmitted_NonEmptyKey_ReplacesStoredKey()
    {
        ...
        var updated = stored.WithSubmitted(
            baseUrl: "http://x", apiKey: "new-secret", selectedVersion: "v3");
