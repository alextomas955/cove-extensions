...
public sealed class ConfigTransportTests
{
    ...
    // Structural defer: v2 never holds IWhisparrFileSettings, so the file-settings verbs have no method to
    // call on a v2 instance — the wire-free deferral is a type-system fact, not a runtime VersionMismatch throw.
    [Fact]
