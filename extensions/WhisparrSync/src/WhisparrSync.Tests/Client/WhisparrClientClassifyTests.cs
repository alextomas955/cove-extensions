...
public sealed class WhisparrClientClassifyTests
{
    ...
    {
        // An empty base URL yields a relative request URI (no BaseAddress). It must classify as
    ...
    {
        // The widened trigger: the register path uses the STORED base URL, which the UI can invoke
