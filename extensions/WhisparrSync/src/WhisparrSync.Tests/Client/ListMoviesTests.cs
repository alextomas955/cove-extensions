...
/// <summary>
/// The data-source contract for <c>WhisparrClient.ListMoviesAsync</c> (GET /api/v3/movie): a
/// live-shaped movie array deserializes into typed <c>WhisparrMovie</c> records, and every
