...
/// principal that HAS or LACKS <c>extensions.configure</c>/<c>extensions.read</c> without a request
...
public sealed class FakePrincipalAccessor : ICurrentPrincipalAccessor
{
    ...
    /// permission keys (e.g. <c>"extensions.configure"</c>). Roles are empty; a dummy UserId/Username is used.
    /// </summary>
