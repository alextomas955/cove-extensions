...
/// every <see cref="StartScan"/> call (the scan fallback probe), and exposes a one-shot
...
internal sealed class FakeScanService : IScanService
{
    ...
    /// <summary>Fires at the start of each <c>ImportDownloaded*</c> call — a seam to snapshot ambient state (e.g. the current principal) mid-ingest.</summary>
