 ...
 * the chooser never offers an op the endpoint would answer with VERSION_UNSUPPORTED. The `MonitorScope` wire
 * union is imported as a type from contracts.ts (erased at runtime).
 */
