 ...
 * Add-defaults because the server rebuilds the saved per-version connection on write, so one save must carry
 * every field). The webhook block and the add defaults moved out to {@link ./ImportWebhookSection} and
...
import { VersionStatusLines } from "./VersionStatusLines";
    ...
    <SectionCard title="Connection" description="How Cove reaches your Whisparr instance.">
      ...
      >
        ...
        <VersionStatusLines
          ...
          versionVerifiedTicks={versionVerifiedTicks}
          whisparrLastReachableTicks={whisparrLastReachableTicks}
        />
      </Field>
