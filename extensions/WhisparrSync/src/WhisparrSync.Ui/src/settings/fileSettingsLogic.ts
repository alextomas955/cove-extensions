/**
 * Pure, DOM-free logic behind the Whisparr file-settings editor: the four file-affecting toggles,
 ...
 *
 * WIRE CONTRACT: the WRITE body is PascalCase (`RenameMovies`, `ReplaceIllegalCharacters`,
 ...
 * `/config/naming`; media-management toggles ride `/config/mediamanagement`.
 */
 ...
 * consequence — turning them on means Whisparr acts on Cove's real files.
 */
