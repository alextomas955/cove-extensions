 ...
 * Add-defaults because the server writes RootFolderId/QualityProfileId unconditionally, so one save must carry
 * every field). The webhook block and the root/quality dropdowns moved out to {@link ./ImportWebhookSection}
 * and {@link ./AddDefaultsSection}.
 *
