/**
 * Pure, DOM-free logic behind the version-aware missing-id guard: the single-sourced
 ...
 * between the scene panel, the monitor button, and any bulk chooser. Kept import-free (no React, no
