/**
 * Logic-guard for the connection-result → copy mapping (CONN-02 / VER-04) and the detected-version →
 * selector mapping (CONN-04). The runner compiles connectionResult.ts and passes the compiled module path
...
test("tones match the UI-SPEC color contract", () => {
...
test("versionMismatch is a warning refusal, not a generic error (VER-04)", () => {
...
test("selectorForDetected maps a version to its selector, null when unparseable (CONN-04)", () => {
