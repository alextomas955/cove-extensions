...
const { classifyActionFailure, actionFailureMessage, actionFailureCopy } = mod;

const ALL_KINDS = ["badKey", "notWhisparr", "unreachable", "noIdentity", "versionUnsupported", "unknown"];

test("classifyActionFailure: 502 discriminates badKey / notWhisparr / unreachable (catch-all)", () => {
