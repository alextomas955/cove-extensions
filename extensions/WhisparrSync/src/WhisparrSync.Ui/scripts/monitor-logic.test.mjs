...
test("statusLineText is exactly 'Monitored in Whisparr · X of Y scenes' (middot separator)", () => {
  assert.equal(statusLineText(12, 40), "Monitored in Whisparr · 12 of 40 scenes");
  assert.equal(statusLineText(5, 18), "Monitored in Whisparr · 5 of 18 scenes");
  assert.equal(statusLineText(0, 3), "Monitored in Whisparr · 0 of 3 scenes");
