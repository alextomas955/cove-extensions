...
[JsonSerializable(typeof(WhisparrMovie[]))]
// The ELEMENT entry, with no array beside it: a streaming enumeration binds one element at a time and never
// the array, so an array entry here would be the type nothing reads.
[JsonSerializable(typeof(WhisparrMovieFacts))]
[JsonSerializable(typeof(WhisparrImage))]
[JsonSerializable(typeof(WhisparrImage[]))]
[JsonSerializable(typeof(WhisparrHistoryPage))]
[JsonSerializable(typeof(WhisparrQueuePage))]
[JsonSerializable(typeof(WhisparrMoviePage))]
...
[JsonSerializable(typeof(WhisparrTag[]))]
[JsonSerializable(typeof(WhisparrNotification))]
[JsonSerializable(typeof(WhisparrNotification[]))]
[JsonSerializable(typeof(WhisparrNotificationField))]
