...
/// <remarks>Registered on both v2 and v3.</remarks>
public interface IWhisparrSearchGrabbing
{
    ...
    /// <remarks>
    /// The generation is a parameter because the two spell the command differently: one takes an id
    /// array and the other a single scalar id, and a body carrying the other's shape is accepted and
    /// does nothing.
    /// <para>
...
/// <remarks>Only v3 registers it: v2 keeps no scene records, so a caller there obtains no role.</remarks>
