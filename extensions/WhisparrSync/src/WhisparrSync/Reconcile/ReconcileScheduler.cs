...
/// <summary>
/// The self-scheduled reconcile loop (IMPT-02): no host cron exists for extensions, so the extension owns a
...
/// serialize (never unbounded-concurrent, T-03-10) and show in the host task list.
/// </summary>
