...
public sealed partial class WhisparrSync
{
    ...
    /// <summary>
    /// Lists the instance's root folders for the settings dropdown. Resolves the connect creds
    ...
    /// classified error on a non-Ok transport result. 403-first on <c>extensions.configure</c>:
