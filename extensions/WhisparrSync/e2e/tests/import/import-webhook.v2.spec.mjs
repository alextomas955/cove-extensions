...
//
// The delivery body is the one a real instance of THIS generation sent, read from the payload
// capture committed beside the backend tests. Only the file path and its size are rewritten, to name the file this spec
...
test("a v2 delivery registers the file this extension verified on disk", async ({
  ...
  try {
    await registerRootFolder(whisparr.v2.container, whisparr.apiFor("v2"), "v2", WHISPARR_ROOT);
