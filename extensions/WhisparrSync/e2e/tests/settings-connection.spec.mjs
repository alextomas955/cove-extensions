...
// classifies distinctly: a closed port is UNREACHABLE, a reachable-but-non-Whisparr endpoint is a DISTINCT
// reachable-class result, proving the classifier differentiates the two failure modes. The API key used here
// is an obviously-fake value, never a real one.
