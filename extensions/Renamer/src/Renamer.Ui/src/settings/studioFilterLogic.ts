 ...
 * it stays L0 — testable with no environment — exactly like options.ts/primitivesLogic.ts, and so the
 * logic the picker renders on top of is exactly the logic the suite covers.
 */
