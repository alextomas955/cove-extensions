 ...
 * stays L0 — testable with no environment — exactly like options.ts/studioFilterLogic.ts, and so the
 * coercion the editor relies on is exactly the coercion the suite covers.
 *
