...
/// </summary>
/// <remarks>
/// <c>EntityType</c> is the Cove entity-type string, lowercase singular, such as <c>video</c>. There
/// is no per-call options override: options come from the stored <c>RenamerOptions</c>.
/// </remarks>
