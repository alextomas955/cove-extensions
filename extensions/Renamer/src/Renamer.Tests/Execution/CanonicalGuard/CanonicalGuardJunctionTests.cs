...
/// privilege (created via <c>cmd /c mklink /J</c>). It needs no opt-in gate on a Windows dev box, and skips with
/// a reason elsewhere — a junction has no Unix equivalent. Also proves a benign (no-link)
