...
/// </summary>
/// <remarks>
/// Every case here that needs a link or a short name is a <see cref="SkippableFactAttribute"/> gated on
/// the capability it requires, and the gate is load-bearing rather than cosmetic: a guard test that
