...
A Cove extension (`com.alextomas955.renamer`) that bulk-renames, and optionally relocates, library
items from configurable metadata templates. It updates the file on disk and its Cove database
