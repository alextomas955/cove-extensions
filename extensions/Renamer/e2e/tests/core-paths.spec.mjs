...
test("extension installs and reports enabled with UI, API, jobs, and state capabilities", async ({
  api,
}) => {
...
test("clicking Save changes persists a settings edit across a page reload", async ({
  page,
  baseUrl,
}) => {
  const settingsPage = new RenamerSettingsPage(page, baseUrl);
